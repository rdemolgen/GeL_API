...
def get_interpretation_request_json(ir_id, ir_version, reports_v6=True, testing_on=False, token=None, session=None):
    ...
    extra_params="?extra-params=show_referral"

    # Use the correct url if using beta dataset for testing (imported form config.py):
    if testing_on == False:
        request_url = (live_100k_data_base_url + 'interpretation-request/{}/{}/{}'.format(ir_id, ir_version, extra_params))
        
    else:
        request_url = (beta_testing_base_url + 'interpretation-request/{}/{}/{}'.format(ir_id, ir_version, extra_params))
    print(request_url)
...
def get_interpretation_request_list(page_size=100,
                                    ...
                                    token=None,
                                    minimize=True,
                                    interpreter_organisation_name=None,
    ...
    payload = {
        ...
        'search': search,
        'minimize': minimize,
        'interpreter_organisation_name': interpreter_organisation_name,
